            ...
            <label className="block">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-white/10 bg-black/60 px-4 py-3 pr-12 text-sm text-white outline-none focus:border-[#00f3ff] focus:ring-1 focus:ring-[#00f3ff] transition-all duration-300 backdrop-blur-sm"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-white/50 hover:text-[#00f3ff] transition-colors duration-300"
